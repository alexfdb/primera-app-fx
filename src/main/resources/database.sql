...
INSERT INTO usuario (nick, nombre, contrasenia, email) VALUES
    ('Juan', 'Juan Pérez', 'pass123', 'juan@example.com'),
    ('Ana', 'Ana López', 'securePass', 'ana@example.com'),
    ('Carlos', 'Carlos Gómez', 'claveSegura', 'carlos@example.com');
